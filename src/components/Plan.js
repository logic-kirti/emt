    ...
    <div class="w3-container w3-padding">
        ...
        <div class="w3-row">
            <div class="w3-col s12 m12 l12 w3-padding-small">
                ...
                <textarea style={{height:200+'px'}} class="w3-input w3-border w3-round" type='text'></textarea>
            </div>            
        </div>
        ...
        <div class="w3-bar w3-margin-top">    
            <a href="/Ventilation" style={{backgroundColor:'#f3ff47'}} class="w3-button w3-round w3-left">&lt;Previous</a>   
        </div>
    </div>
    );
}
