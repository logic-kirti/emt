  ...
  return (
    <div class="w3-container w3-padding">
        ...
        <div class="w3-bar w3-margin-top">    
            <a href="/BloodTrans" style={{backgroundColor:'#f3ff47'}} class="w3-button w3-round w3-left">&lt;Previous</a>   
            <a href="/LastIO" style={{backgroundColor:'#f3ff47'}} class="w3-button w3-round w3-right">Next&gt;</a>           
        </div>v
    </div>
    );
}
