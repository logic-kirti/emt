  ...
  return (
    <div class="w3-container w3-padding">
        ...
        <div class="w3-row w3-margin-top">
            <div class="w3-col s12 m6 l5 w3-padding-small w3-leftt">
                <label >UHID</label>
        ...
        <div class="w3-bar w3-margin-top">    
            <a href="/Lab" style={{backgroundColor:'#f3ff47'}} class="w3-button w3-round w3-left">&lt;Previous</a>   
            <a href="/Surgery" style={{backgroundColor:'#f3ff47'}} class="w3-button w3-round w3-right">Next&gt;</a>           
        </div>
    </div>
    );
}
