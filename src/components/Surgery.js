    ...
    <div class="w3-container w3-padding">
        ...
        <div class="w3-row">
            <div class="w3-col s12 m12 l6 w3-padding-small ">  
                <label>Faculty Surgeon1 Name</label>              
                <input class="w3-input w3-border w3-round " type='text'></input>
            </div>  
            <div class="w3-col s12 m12 l6 w3-padding-small ">  
                <label>Faculty Surgeon2 Name</label>              
                <input class="w3-input w3-border w3-round " type='text'></input>
            </div>           
        </div>
        <div class="w3-row">
            <div class="w3-col s12 m12 l6 w3-padding-small ">  
                <label>SR Surgeon1 Name</label>              
                <input class="w3-input w3-border w3-round " type='text'></input>
            </div>  
            <div class="w3-col s12 m12 l6 w3-padding-small ">  
                <label>SR Surgeon2 Name</label>              
                <input class="w3-input w3-border w3-round " type='text'></input>
            </div>           
        </div>
        ...
        <div class="w3-bar w3-margin-top">    
            <a href="/ABG" style={{backgroundColor:'#f3ff47'}} class="w3-button w3-round w3-left">&lt;Previous</a>   
            <a href="/BloodTrans" style={{backgroundColor:'#f3ff47'}} class="w3-button w3-round w3-right">Next&gt;</a>           
        </div>
